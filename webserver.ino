...
const char *softAP_ssid = "RAIMO_UNIT32 SETUP";
...
void coolLedEffect() {
  ticks += 16;
  long phaseLen = 2048;  
  long halfPhase = phaseLen / 2;
  long phase = ticks % phaseLen;
  long val = phase < halfPhase ? phase : phaseLen - phase;
  showColor(val, 1024 - val);
}
...
void handleWifiSave() {
  Serial.println("Handling Wifi settings save");
